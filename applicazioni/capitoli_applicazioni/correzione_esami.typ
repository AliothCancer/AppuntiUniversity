...
=== Risultati
$omega = 86.143 "rad/s" = 822.605 "RPM"$ 
...
Per ottenere il massimo lavoro utile si assume che $alpha_1= 90°$(stando a quanto confermato da Campiglio) e la velocità relativa $V_1$ deve essere allineata con $beta_1$(stando a quanto detto da Remuzzi) che in questo caso è dato pari a 30°.
