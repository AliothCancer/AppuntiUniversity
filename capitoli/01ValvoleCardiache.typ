...
= Valvole Cardiache
  == Apertura e chiusura delle valvole
    ...
    formata da lembi sottili di tessuto unito alia base a un anello di 
    tessuto connettivo. I lembi sono lievemente ispessiti ai margini e 
    sono connessi al lato ventricolare attraverso tendini ricchi di collaSene, le corde tendinee (rigura 14.7a,c). La maggior parte delle corde tendinee si salda ai margini dei lembi delle valvole. Le estremità opposte delle 
